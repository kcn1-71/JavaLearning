package ru.clinicWebServlet.clinicPetWeb;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.append(
                "<!DOCTYPE html>" +
                        ...
                        "</head>" +
                        "<body>" +
                        "     <form action='" + req.getContextPath() + "/' name='addClient' method='post'>" +
                        ...
                        "     <form action='" + req.getContextPath() + "/' name='searchForClient' method='post'>" +
